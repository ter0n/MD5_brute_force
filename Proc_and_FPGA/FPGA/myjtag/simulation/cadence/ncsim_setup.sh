...
TOP_LEVEL_NAME="myjtag"
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="F:/intelfpga_lite/17.1/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
mkdir -p ./libraries/virtual_jtag_0/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/sld_virtual_jtag.v" -work virtual_jtag_0 -cdslib ./cds_libs/virtual_jtag_0.cds.lib
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/myjtag.v"                                                                                    
fi
